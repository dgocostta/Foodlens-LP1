...
// The full lockup is a light/gradient wordmark that would wash out on the white
// email card, so we sit it on a small dark rounded band. The band is explicitly
// dark regardless of the client's theme, so the logo reads in both light and
// dark email clients. (MSO conditional gives Outlook the same dark cell.)
function logoBandHtml() {
  return `<div style="margin-bottom:28px;">
    <!--[if mso]><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr><td style="background:#0b0b0d;border-radius:12px;padding:12px 16px;" bgcolor="#0b0b0d"><![endif]-->
    <span style="display:inline-block;background:#0b0b0d;border-radius:12px;padding:12px 16px;line-height:0;">
      <img src="${PUBLIC_BASE_URL}/foodlens-logo.png" alt="FoodLens Group" height="28" style="display:block;height:28px;width:auto;border:0;outline:none;text-decoration:none;" />
    </span>
